...
spaceShuttle.printDaysToLocation(new SpaceLocation_1.SpaceLocation('Mars', kilometerToMars));
spaceShuttle.printDaysToLocation(new SpaceLocation_1.SpaceLocation('Moon', kilometerToMoon));
